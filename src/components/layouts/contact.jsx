...
export default function Contact() {
    ...
    return (
        <div className="relative z-3 w-[73%] mx-auto pb-24">
            <div
            ...
            >
                <h2 className="text-4xl font-medium text-foreground max-w-3xl leading-tight tracking-tighter">
                    I love digging into problems, mapping out systems, and figuring out what actually works. Let&apos;s talk!
                </h2>

                <div className="flex flex-wrap justify-center gap-4 mt-10 text-xl font-medium">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-2 mt-12 text-foreground-2">
                <div>
            ...
            <div className="border-t border-neutral-200 mt-8 pt-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
